export const metadata = {
  ...
  alternates: {
    canonical:
      "https://www.axisstrategiesgroup.com/pharmacy-revenue-optimization",
  },
};
      ...
      <section className="bg-slate-50 py-20">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-200 p-6">
              <h3 className="text-lg font-semibold">
                Specialty & Infusion Opportunity
              </h3>
              <p className="mt-3 text-slate-600">
            ...
            <div className="rounded-2xl border border-slate-200 p-6">
              <h3 className="text-lg font-semibold">
                New Pharmacy Startup & Stabilization
              </h3>
              <p className="mt-3 text-slate-600">
                Support startup planning, launch readiness, and early-stage
                stabilization for new pharmacy operations, including workflow
                design, staffing strategy, volume ramp-up, performance
            ...
            <div className="rounded-2xl border border-slate-200 p-6">
              ...
              <p className="mt-3 text-slate-600">
                Axis supports healthcare organizations pursuing specialty
                pharmacy accreditation through nationally recognized bodies such
                as URAC and ACHC. We help clients prepare for credentialing by
                aligning clinical programs, operational workflows, compliance
                frameworks, and quality management systems required for
                specialty pharmacy recognition.
              </p>
              <p className="mt-3 text-slate-600">
                Our approach ensures credentialing efforts support broader
                pharmacy growth strategies, including specialty medication
                management, referral capture, and long-term revenue
                optimization.
              </p>
            </div>
          </div>
